...
import ProductManagerWeek1Div from "../ProductManagerPageComponents/ProductManagerWeek1Div";
import ProductManagerFirstTwoWeeks from "../ProductManagerPageComponents/ProductManagerFirstTwoWeeks";
import ProductManagerFirstMonth from "../ProductManagerPageComponents/ProductManagerFirstMonth";

function ProductMangerPage() {
    ...
    <div className="mainDiv">
      ...
      <div className="flexDiv">
        ...
        <div ref={(el) => (divRefs.current[0] = el)}>
          <ProductManagerWeek1Div />
        </div>

        <div
          ref={(el) => (divRefs.current[1] = el)}
          style={{ display: "none" }}>
          <ProductManagerFirstTwoWeeks />
        </div>

        <div
          ref={(el) => (divRefs.current[2] = el)}
          style={{ display: "none" }}>
          <ProductManagerFirstMonth />
        </div>
...
export default ProductMangerPage;
